...
- A faixa acima do compositor mostra a última nota de progresso, o status e o uso de tokens, com um botão de pausar/retomar integrado.
- O botão de alvo fica aceso enquanto o objetivo roda (azul), fica verde ao concluir e vermelho quando bloqueado ou sem orçamento. Pressione-o para abrir o diálogo do objetivo: edite o objetivo ou o orçamento, ou remova-o (um objetivo concluído é removido antes de iniciar um novo).
