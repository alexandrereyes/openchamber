...
- The global hub classifies internal OpenChamber sessions before replay or fan-out. Lookups for separate sessions start concurrently, while accepted events retain upstream order. Restarting the hub invalidates queued events from the previous OpenCode runtime.
