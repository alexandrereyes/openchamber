export const settingsDict = {
  ...
  'settings.view.navigation.interface': '인터페이스',
  'settings.view.navigation.workspace': '작업 공간',
  'settings.view.navigation.openCode': 'OpenCode',
  'settings.view.navigation.resources': '리소스',
  'settings.view.navigation.advanced': '고급',
