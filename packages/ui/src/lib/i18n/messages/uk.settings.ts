export const settingsDict = {
  ...
  'settings.view.navigation.interface': 'Інтерфейс',
  'settings.view.navigation.workspace': 'Робочий простір',
  'settings.view.navigation.openCode': 'OpenCode',
  'settings.view.navigation.resources': 'Ресурси',
  'settings.view.navigation.advanced': 'Розширені',
