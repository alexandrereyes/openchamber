...
export const dict: Record<I18nKey, string> = {
  ...
  'header.actions.smallModelTest': '小模型测试',
  'dialog.smallModelTest.title': '小模型测试',
  'dialog.smallModelTest.description': '将提示词直接发送给解析出的小模型。',
  'dialog.smallModelTest.promptPlaceholder': '输入提示词…',
  'dialog.smallModelTest.providerLabel': '提供商',
  'dialog.smallModelTest.modelLabel': '模型',
  'dialog.smallModelTest.run': '运行',
  'dialog.smallModelTest.running': '运行中…',
