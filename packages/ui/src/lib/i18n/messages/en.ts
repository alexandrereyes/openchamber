...
export const dict = {
  ...
  'header.actions.smallModelTest': 'Small model test',
  'dialog.smallModelTest.title': 'Small Model Test',
  'dialog.smallModelTest.description': 'Sends a prompt straight to the resolved small model.',
  'dialog.smallModelTest.promptPlaceholder': 'Enter a prompt…',
  'dialog.smallModelTest.providerLabel': 'Provider',
  'dialog.smallModelTest.modelLabel': 'Model',
  'dialog.smallModelTest.run': 'Run',
  'dialog.smallModelTest.running': 'Running…',
