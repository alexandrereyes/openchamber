...
export const dict: Record<I18nKey, string> = {
  ...
  'header.actions.smallModelTest': '소형 모델 테스트',
  'dialog.smallModelTest.title': '소형 모델 테스트',
  'dialog.smallModelTest.description': '확인된 소형 모델로 프롬프트를 직접 전송합니다.',
  'dialog.smallModelTest.promptPlaceholder': '프롬프트 입력…',
  'dialog.smallModelTest.providerLabel': '제공자',
  'dialog.smallModelTest.modelLabel': '모델',
  'dialog.smallModelTest.run': '실행',
  'dialog.smallModelTest.running': '실행 중…',
