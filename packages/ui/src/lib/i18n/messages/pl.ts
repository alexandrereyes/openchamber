...
export const dict: Record<I18nKey, string> = {
  ...
  'header.actions.smallModelTest': 'Test małego modelu',
  'dialog.smallModelTest.title': 'Test małego modelu',
  'dialog.smallModelTest.description': 'Wysyła prompt bezpośrednio do wybranego małego modelu.',
  'dialog.smallModelTest.promptPlaceholder': 'Wpisz prompt…',
  'dialog.smallModelTest.providerLabel': 'Dostawca',
  'dialog.smallModelTest.modelLabel': 'Model',
  'dialog.smallModelTest.run': 'Uruchom',
  'dialog.smallModelTest.running': 'Wykonywanie…',
