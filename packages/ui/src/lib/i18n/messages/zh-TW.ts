...
export const dict: Record<I18nKey, string> = {
  ...
  'header.actions.smallModelTest': '小模型測試',
  'dialog.smallModelTest.title': '小模型測試',
  'dialog.smallModelTest.description': '將提示詞直接傳送給解析出的小模型。',
  'dialog.smallModelTest.promptPlaceholder': '輸入提示詞…',
  'dialog.smallModelTest.providerLabel': '供應商',
  'dialog.smallModelTest.modelLabel': '模型',
  'dialog.smallModelTest.run': '執行',
  'dialog.smallModelTest.running': '執行中…',
