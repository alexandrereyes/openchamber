...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.view.navigation.interface': 'Interfejs',
  'settings.view.navigation.workspace': 'Obszar roboczy',
  'settings.view.navigation.openCode': 'OpenCode',
  'settings.view.navigation.resources': 'Zasoby',
  'settings.view.navigation.advanced': 'Zaawansowane',
