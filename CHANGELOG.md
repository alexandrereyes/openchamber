...
- Walkthrough: models provided through OpenCode plugins can now generate walkthroughs when their custom transport prevents a direct provider request (thanks to @alexandrereyes).
...
- Mobile: swipe a session in the session switcher to reveal archive and delete actions. Delete requires a second tap for confirmation (thanks to @alexandrereyes).
